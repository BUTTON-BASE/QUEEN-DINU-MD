...
cmd({
    ...
    try {
        await reply("🔍 Checking for QUEEN-DINU-MD updates...");

        // Fetch the latest commit hash from GitHub
        const { data: commitData } = await axios.get("https://api.github.com/repos/DNX-MD/QUEEN-DINU-MD/commits/main");
        ...
        if (latestCommitHash === currentHash) {
            return reply("✅ Your QUEEN-DINU-MD bot is already up-to-date!");
        }

        await reply("🚀 Updating QUEEN-DINU-MD Bot...");
        ...
        const sourcePath = path.join(extractPath, "QUEEN-DINU-MD-main");
